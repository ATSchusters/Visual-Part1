...
# Preparing data
# X is based on the day of the week
# Y is based on the week of the month
# Z collects all of the recovered cases amoung all countries which also sets the color
