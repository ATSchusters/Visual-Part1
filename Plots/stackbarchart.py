...
# Preparing data
# They each collect that data of the top 20 due to the filters set earlier
# trace 1 retrieves the numbers specified by the df['Unrecovered'] column
trace1 = go.Bar(x=new_df['Country'], y=new_df['Unrecovered'], name='Unrecovered',
                marker={'color': '#CD7F32'})
# trace 2 retrieves the numbers specified by the Recovered column in the data set
trace2 = go.Bar(x=new_df['Country'], y=new_df['Recovered'], name='Recovered',
                marker={'color': '#9EA0A1'})
# trace 3 retrieves the numbers specified by the Deaths column in the data set
