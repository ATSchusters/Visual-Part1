...
# Preparing data
# X sets it's position based on the number of recovered cases
# Y sets the position based on number of current sick people
# The size is made by scaling the total amount of cases as well as color
data = [
